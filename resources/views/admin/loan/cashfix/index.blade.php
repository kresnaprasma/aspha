			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="col-md-12 box-body-header">
					   <div class="col-md-8">
					      <a href="{{ route('admin.loan.cashfix.create') }}" class="btn btn-default">
					...
					{!! Form::open(['route'=>'admin.loan.cashfix.delete', 'id'=>'formDeleteCashfix']) !!}
					<div>
    	...
    	$('#tableCashfix tbody').on('dblclick', 'tr', function () {
      		if ( $(this).hasClass('selected') ) {
	        	...
	        	var id = $(this).find('#idTableCashfix').val();
	          	window.location.href = "/admin/loan/cashfix/"+id+"/edit";
	      	}
    	});
