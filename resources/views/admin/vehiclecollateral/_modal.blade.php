	...
	{{-- Create Modal --}}
	{{-- <div class="modal fade" id="createCollateralModal" tabindex="-1" role="dialog" aria-labelledby="Create Department">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					...
					<h4 class="modal-title" id="CreateColor">Create Collateral</h4>
				</div>

				<div class="form-group">
					{!! Form::label('merk_id', 'Merk:') !!}
					<select name="merk_id" id="merk_id" class="form-control" style="width: 375px">
				...
				<div class="form-group">
					{!! Form::label('type_id', 'Type:') !!}
					<select name="type_id" id="type_id" class="form-control" style="width: 375px">
					</select>
				</div>
				<div class="form-group">
					{!! Form::label('vehicle_date', 'Vehicle Date:') !!}
